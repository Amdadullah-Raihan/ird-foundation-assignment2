...
const FilterBooksBtn = () => {
  ...
  return (
    <div className="flex items-center w-full gap-2 p-3 mt-1 bg-white dark:bg-[#202020]   dark:bg-[#202020] rounded-lg md:mt-0 md:bg-none md:p-0">
      <button
      ...
      >
        <div className="flex justify-between p-3 py-6 bg-white dark:bg-[#202020]   dark:bg-[#202020] ">
          <p>ক্যাটাগরি</p>
